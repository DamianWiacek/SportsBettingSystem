...
class Dowodos(models.Model):
    ...
    uzytkownikid = models.ForeignKey('Uzytkownik', models.DO_NOTHING, db_column='UzytkownikID', unique=True)  # Field name made lowercase.
...
class Wydarzenie(models.Model):
    ...
    gospodarzid = models.ForeignKey(Uczestnik, models.DO_NOTHING, db_column='GospodarzID')  # Field name made lowercase.
    goscid = models.ForeignKey(Uczestnik, models.DO_NOTHING, db_column='GoscID')  # Field name made lowercase.
